...
export default function ContactAndLocation({ onOpenEnroll }) {
  return (
    <section id="contact" className="py-12 sm:py-16 bg-slate-100/90 text-slate-900 border-b border-slate-200">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        
        {/* Header */}
        <div className="text-center max-w-3xl mx-auto mb-10">
          <div className="inline-flex items-center gap-1.5 bg-navy-800 text-white text-[10px] sm:text-xs font-bold uppercase tracking-wider px-3 py-1 rounded-full mb-2.5 shadow-sm">
        ...
        <div className="grid lg:grid-cols-12 gap-6 items-start">
          ...
          <div className="lg:col-span-6 space-y-5">
            ...
            <div className="bg-white border-2 border-slate-200 rounded-3xl p-5 sm:p-8 shadow-md space-y-5">
              
              <div className="flex items-start gap-3 sm:gap-4">
                <div className="p-2.5 sm:p-3 bg-blue-50 rounded-2xl text-navy-800 border border-blue-100 flex-shrink-0">
                  <MapPin className="w-5 h-5 sm:w-6 sm:h-6" />
                </div>
                <div>
                  <h4 className="font-display font-extrabold text-navy-900 text-xs sm:text-sm">Center Address</h4>
                  ...
                  <a 
                    ...
                    target="_blank" 
                    rel="noreferrer"
                    className="inline-flex items-center gap-1.5 text-[11px] sm:text-xs text-navy-700 hover:text-navy-900 font-bold mt-2 bg-blue-50 px-3 py-1.5 rounded-lg border border-blue-200"
                  >
              ...
              <div className="flex items-start gap-3 sm:gap-4 border-t border-slate-100 pt-4">
                ...
                <div>
                  ...
                  <a href={`tel:${ACADEMY_INFO.phone}`} className="text-navy-900 font-display font-black text-xl sm:text-2xl hover:text-navy-700 transition block">
                    {ACADEMY_INFO.phone}
                  </a>
              ...
              <div className="grid grid-cols-2 gap-3 border-t border-slate-100 pt-4">
                ...
                <div className="flex items-center gap-2">
                  <Clock className="w-4 h-4 sm:w-5 sm:h-5 text-navy-800 flex-shrink-0" />
                  <div>
              ...
              <div className="pt-2 flex flex-col sm:flex-row gap-2.5">
                ...
                <button
                  ...
                  className="flex-1 bg-navy-800 hover:bg-navy-700 text-white font-bold text-xs py-3 rounded-xl shadow-md transition"
                >
                  Request Callback
                </button>
              </div>
          ...
          <div className="lg:col-span-6 bg-white border-2 border-slate-200 rounded-3xl p-3 shadow-md h-full flex flex-col">
